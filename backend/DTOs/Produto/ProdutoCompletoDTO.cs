...
public class ProdutoCompletoDTO
{
    ...
    public ICollection<AvaliacaoDTO> Avaliacoes { get; set; } = new List<AvaliacaoDTO>();
    public ICollection<ComentarioProdutoDTO> ComentariosProduto { get; set; } = new List<ComentarioProdutoDTO>();
}
