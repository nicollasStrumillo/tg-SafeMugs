...
namespace backend.Migrations
{
    ...
    [Migration("20260726235121_AlteraModelDesafio")]
    partial class AlteraModelDesafio
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("backend.models.Desafio", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            DescricaoDetalhes = "O payload |<iframe src=\"javascript:alert(`XSS`)\">| é um exemplo de ataque de DOM XSS. Ele insere um iframe que executa código JavaScript quando a página é carregada. Isso pode ser usado para roubar informações do usuário ou executar ações não autorizadas.",
                            Dificuldade = 2,
                            Nome = "DOM XSS",
                            Resolvido = false
                        },
                        ...
                        new
                        {
                            ...
                            DescricaoDetalhes = "O payload |<iframe src=\"javascript:alert(`XSS`)\">| é um exemplo de ataque de Stored XSS. Ele insere um iframe que executa código JavaScript quando a página é carregada. Isso pode ser usado para roubar informações do usuário ou executar ações não autorizadas.",
                            Dificuldade = 3,
                            Nome = "Stored XSS",
                            Resolvido = false
                        },
